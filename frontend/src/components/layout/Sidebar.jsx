...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white/80 dark:bg-black/20 backdrop-blur-xl border-r border-gray-200 dark:border-white/10 flex flex-col shadow-2xl z-20 relative transition-colors duration-300">
      <div className="p-6 border-b border-gray-200 dark:border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyber-500 to-electric-500 flex items-center justify-center shadow-lg">
            <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
            </svg>
          </div>
          <div>
            <h2 className="font-display font-bold text-gray-800 dark:text-white text-lg tracking-tight">
              Face Attendance
            </h2>
        ...
        {links.map(({ to, label, icon }) => (
          ...
          >
            {({ isActive }) => (
              <>
                {isActive && (
                  <div className="absolute inset-0 bg-gradient-to-r from-cyber-600 to-electric-600 opacity-100" />
                )}
